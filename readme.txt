...
Теперь основные файлы локализации (помимо тех, которые в Saphali woocommerce Lite) находятся здесь:
...
= Особенности =
* C версии WooCommerce 8.3 используются по умолчанию поля в виде блоков (т.е. поля настраиваются как бы при редактировании самой страницы Оформления заказа). Чтобы использовать возможности данного плагина <strong>нужно просто переключится на Сlassic Shortcode (Класический шорткод)</strong> при редактировании страницы <em>Оформления заказа</em> (Checkout).
...
1. Возможность выводить поле в зависимости от метода доставки или оплаты.
...
6. Переключение на Сlassic Shortcode (Класический шорткод) при редактировании страницы Оформления заказа (Checkout).
